...
export const basemaps: Basemaps[] = [
  {
    ...
    attribution: "Esri, HERE, Garmin, USGS, Intermap, INCREMENT P, NRCan, Esri Japan, METI, Mapwithyou, NOSTRA, © OpenStreetMap contributors, and the GIS User Community",
  },
  {
    basemap: "satellite",
    url: "https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}",
    attribution: "Esri, USGS | Esri, TomTom, FAO, NOAA, USGS | Earthstar Geographics",
  },
  {
    basemap: "topo",
    url: "https://server.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}",
    attribution: "Esri, USGS | Esri, TomTom, FAO, NOAA, USGS | Esri, HERE, FAO, NOAA"
  },
  {
